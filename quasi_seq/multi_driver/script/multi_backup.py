...
def fullrecursionpipeline(*args):
	 ...
	 if ranked_amount  >= snpthresh:
		...
		command = "java -classpath .:/usr/local/MATLAB/MATLAB_Runtime/v91/toolbox/javabuilder/jar/javabuilder.jar:../../cluster_interface/SigClust.jar getClust /opt/quasi-seq/testing/data/" + cluster_parameters[3] + " /opt/quasi-seq/testing/data/" + cluster_parameters[4] + " " + cluster_parameters[6]  
		print command
