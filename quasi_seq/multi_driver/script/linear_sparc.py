...
def fullrecursionpipeline(*args):
	 ...
	 if ranked_amount  >= snpthresh:
		adjustedQueue = dict(sampleQueue)  
	 	...
	 	print "THIS IS THE CLUSTERING COMMAND"		
		#command = "java -classpath .:/usr/local/MATLAB/MATLAB_Runtime/v91/toolbox/javabuilder/jar/javabuilder.jar:/mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/scripts/SigClust/for_testing/SigClust.jar getClust /mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/rishub_backup/testing_brad/" + cluster_parameters[3] + " /mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/rishub_backup/testing_brad/" + cluster_parameters[4] + " " + cluster_parameters[6]  
	      #  command = "java -classpath .:/usr/local/MATLAB/MATLAB_Runtime/v91/toolbox/javabuilder/jar/javabuilder.jar:/mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/scripts/selfTuned_sigClust/for_testing/SigClust.jar getClust /mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/rishub_backup/rerun/" + cluster_parameter[4] + " " + cluster_parameters[6]
		command = command = "java -classpath .:/usr/local/MATLAB/MATLAB_Runtime/v91/toolbox/javabuilder/jar/javabuilder.jar:/mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/scripts/selfTuned_sigClust/for_testing/SigClust.jar getClust /mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/rishub_backup/rerun/" + cluster_parameters[3] + " /mnt/LHRI/Bioinformatics/Projects/Quasispecies/manuscript/rishub_backup/rerun/" + cluster_parameters[4] + " " + cluster_parameters[6]
		print command
